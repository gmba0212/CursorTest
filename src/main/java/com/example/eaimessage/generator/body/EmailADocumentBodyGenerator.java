...
public class EmailADocumentBodyGenerator implements EaiBodyGenerator {
    ...
    private static final Logger log = LoggerFactory.getLogger(EmailADocumentBodyGenerator.class);
    ...
    public BodyData generate(TalkRequest request) {
        log.debug("EMAIL A_DOCUMENT 본문 생성 시작 receiverId={}", request.getReceiverId());
