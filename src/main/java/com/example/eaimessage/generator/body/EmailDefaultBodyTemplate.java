...
public class EmailDefaultBodyTemplate implements DefaultBodyTemplate {
    ...
    private static final Logger log = LoggerFactory.getLogger(EmailDefaultBodyTemplate.class);
    ...
    public String generate(BodyData data) {
        log.trace("EMAIL 본문 템플릿 조립 messageType={}, receiverId={}", data.messageType(), data.receiverId());
        ...
        log.debug("EMAIL 본문 문자열 생성 완료 totalChars={}", body.length());
        return body;
    }
